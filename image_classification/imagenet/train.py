...
parser.add_argument('-a', '--arch', metavar='ARCH', default='dla_50',
                    choices=model_names,
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    lr = gen_lr(epoch, args)
    # lr = step_lr(epoch, args)
    for param_group in optimizer.param_groups:
        param_group['lr'] = lr
    # return lr    
    
def gen_lr(epoch, args):
    if args.warmup_epochs and epoch < args.warmup_epochs:
        warmup_percent_done = epoch / args.warmup_epochs
